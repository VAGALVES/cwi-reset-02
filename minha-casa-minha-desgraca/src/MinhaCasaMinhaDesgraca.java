...
public class MinhaCasaMinhaDesgraca {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Endereco enderecoSc01 = new Endereco("Servidão Gustavo Abraão", 715, null, "Ingleses", "Florianópolis", UnidadeFederativa.SC);
        Imovel imovelSc01 = new Imovel(enderecoSc01, 778000.0);

        Endereco enderecoSp = new Endereco("Rua dos Guararapes", 850, null, "Bairro Perdizes", "Belo Horizonte", UnidadeFederativa.SP);
        Imovel imovelSp = new Imovel(enderecoSp, 99851.0);

        Endereco enderecoRs01 = new Endereco("Rua Horacio Vaz", 65, null, "Rubem Berta", "Porto Alegre", UnidadeFederativa.RS);
        Imovel imovelRs01 = new Imovel(enderecoRs01, 3322110.0);

        Endereco enderecoRj01 = new Endereco("Rua Sp 2", 33, null, "Lapa", "Rio de Janeiro", UnidadeFederativa.RJ);
        Imovel imovelRj01 = new Imovel(enderecoRj01, 220886.0);

        Endereco enderecoAC01 = new Endereco("Rua Castelo Branco", 7, null, "Terezina", "Rio Branco", UnidadeFederativa.AC);
        Imovel imovelAc01 = new Imovel(enderecoAC01, 345000.0);

        Endereco enderecoRs02 = new Endereco("Avenida da Azenha", 1800, null, "Azenha", "Porto Alegre", UnidadeFederativa.RS);
        Imovel imovelRs02 = new Imovel(enderecoRs02, 322000.0);

        Endereco enderecoSc02 = new Endereco("Servidão Serafino Correa", 226, null, "Ponta das Canas", "Florianópolis", UnidadeFederativa.SC);
        Imovel imovelSc02 = new Imovel(enderecoSc02, 315984.0);

        Endereco enderecoAC02 = new Endereco("Rua Passarinho", 88, null, "Presidente Roosvel", "Rio Branco", UnidadeFederativa.AC);
        Imovel imovelAc02 = new Imovel(enderecoAC02, 1000000.0);


        opcoesParaFinanciamento.registrarImovel(imovelSc01);
        opcoesParaFinanciamento.registrarImovel(imovelSp);
        opcoesParaFinanciamento.registrarImovel(imovelRs01);
        opcoesParaFinanciamento.registrarImovel(imovelRj01);
        opcoesParaFinanciamento.registrarImovel(imovelAc01);
        opcoesParaFinanciamento.registrarImovel(imovelRs02);
        opcoesParaFinanciamento.registrarImovel(imovelSc02);
        opcoesParaFinanciamento.registrarImovel(imovelAc02);
